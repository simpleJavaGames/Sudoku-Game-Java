...
public class startMenuController {
    ...
    protected void onPlayButtonClicked(){
        String boardSize = boardSizeChoiceBox.getValue();
        int boardSizeInt = 3;
        ...
        try{
            FXMLLoader loader = new FXMLLoader(Objects.requireNonNull(getClass().getResource("/com/schoolaccount32/sudoku/sudokuGame.fxml")));
